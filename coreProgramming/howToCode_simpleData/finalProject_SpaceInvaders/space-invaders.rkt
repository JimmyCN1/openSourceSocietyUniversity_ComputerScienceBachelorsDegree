...
(check-expect (move-invaders LOI-3)
...
(check-expect (move-tank T1)
              (make-tank (+ 50 TANK-SPEED) 1))   ;moving right
...
;(define (invaded indaver) false)     ;stub
